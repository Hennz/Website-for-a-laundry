      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="add_funcionario.php">Adicionar Funcionário</a></li>
...
<form class="form-horizontal"  action="add_funcionario.php" method="POST"  enctype="multipart/form-data" >
		...
		<div class="col-sm-10">
		<input type="text" name="vencimento" class="form-control" id="vencimento" placeholder="Vencimento">
    </div>
  </div>
	...
	<input name="submeter" type="submit" value="Adicionar funcionario"/>
</form>
...
<?php
	...
	$sql="insert into empregados (FirstName, LastName, email, morada, Cod_Postal, Pais, Telemovel, BI, Password,  Image, Vencimento) values('".$_POST["name"]."', '".$_POST["apelido"]."', '".$_POST["email"]."', '".$_POST["morada"]."', '".$_POST["codpostal"]."','".$_POST["pais"]."','".$_POST["telemovel"]."', '".$_POST["bi"]."', '".crypt($_POST["password"])."', '".$data."','".$_POST["vencimento"]."');";
    //echo $sql;
	...
	if($connect){
		...
		<strong>Successo!</strong> Funcionário inserido com sucesso!
	</div>
		<?php
	}else{
		?>
		<div class="alert alert-danger">
		<strong>Erro!</strong> O Funcionário não foi inserido com sucesso!
    </div>
	<?php
