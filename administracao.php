...
<br/> 
<div class="container">
<form class="form-signin" action="administracao.php" method="POST"  enctype="multipart/form-data" >
...
$sql = "select Password from administrador where Email= '".$_POST['email']."'";
//echo $sql;
...
if($result){
  ...
  echo "<script>window.location = 'administracao2.php'</script>";
	}
}	
?>
